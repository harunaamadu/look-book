              ...
              <div className="flex gap-3">
                {["Instagram", "Pinterest", "TikTok"].map((s) => (
                  <Link
                    key={s}
                    href="#"
                    className="px-4 py-2 border border-stone-200 text-[10px] tracking-[0.3em] uppercase text-stone-500 hover:border-stone-900 hover:text-stone-900 transition-all"
                  >
                    {s}
                  </Link>
                ))}
            ...
            {formState === "success" ? (
              <div className="h-full flex flex-col items-center justify-center text-center gap-6 py-16">
                ...
                <button
                  ...
                  className="text-[10px] tracking-[0.35em] uppercase text-stone-400 underline underline-offset-4 hover:text-stone-900 transition-colors"
                >
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <button
                    ...
                    className="w-full bg-stone-900 text-white py-4 text-[11px] tracking-[0.35em] uppercase hover:bg-stone-700 transition-colors disabled:opacity-60 mt-2"
                  >
                    {formState === "loading" ? (
