...
export default async function Advertisement() {
  ...
  return (
    <Reveal>
      <section className="max-w-7xl mx-auto px-6 py-16" data-reveal>
          ...
          <div className="relative overflow-hidden bg-stone-900 group h-130">
            ...
            <div className="absolute bottom-0 left-0 p-8 flex flex-col gap-4">
              ...
              <Link
                ...
                className="self-start bg-white text-stone-900 px-7 py-3 text-xs tracking-[0.35em] uppercase hover:bg-stone-100 transition-colors"
              >
                Shop now
              </Link>
            </div>
            ...
            <div className="relative overflow-hidden bg-[#e8e0d5] group h-62">
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end gap-3">
                ...
                <Link
                  ...
                  className="self-start text-xs tracking-[0.35em] uppercase text-white border-b border-white/50 hover:border-white pb-0.5 transition-colors"
                >
                  Shop sale →
                </Link>
              </div>
            ...
            <div className="relative overflow-hidden bg-stone-100 group h-62 flex">
              ...
              <div className="relative z-10 flex flex-col justify-center gap-4 p-8 w-1/2">
                ...
                <p className="text-xs text-stone-500 leading-relaxed">
                  On all orders over {formatPrice(150, currency)}. No code
                  needed.
                </p>
                <Link
                  href="/products"
                  className="self-start text-xs tracking-[0.35em] uppercase text-stone-900 border-b border-stone-400 hover:border-stone-900 pb-0.5 transition-colors"
                >
                  Explore →
                </Link>
              </div>
